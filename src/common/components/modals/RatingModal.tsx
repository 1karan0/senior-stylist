...
const RatingModal: React.FC<RatingModalProps> = ({
  ...
  return (
    <ModalWrapper
      ...
      containerClassName={`border rounded-2xl ${isDark ? 'bg-[#0D1A16] border-[#273F36]' : 'bg-white border-[#DAE7E0]'} px-5 py-6`}
      overlay={<StatusBar translucent backgroundColor="#000000D1" barStyle="light-content" />}
    >
      <KeyboardAvoidingView
      ...
      >
        ...
        >
          <View style={{ position: 'relative' }}>
            ...
            {/* Title */}
            <Text
              className={`text-start text-xl font-poppins-semibold mt-2 pr-8 ${
