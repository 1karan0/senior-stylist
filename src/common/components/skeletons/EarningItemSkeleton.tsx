...
const EarningItemSkeleton: React.FC = () => {
...
const EarningListSkeleton: React.FC = () => {
  return (
    <>
      {[1, 2, 3].map((item) => (
        <EarningItemSkeleton key={item} />
      ))}
    </>
  );
};

export default EarningItemSkeleton;
export { EarningListSkeleton };
