...
import { View, Text, TextInput, Pressable, Image, Alert, ActivityIndicator, ScrollView } from "react-native";
        ...
        try {
            ...
            if (user === "consultant") {
                ...
                response = await axios.post(
                    `${BASE_URL}/api/consultant/register`,
                    data,
                    {
        ...
        <ScrollView>
            ...
            >
                <View className="">
                    ...
                    {user === "consultant" && (
                        <View className="mb-5">
                            ...
                            >
                                ...
                                <Text className="text-[#658176] text-[12px]">
                                    .pdf , .docx , .doc
                                </Text>
                            </Pressable>
                    ...
                    <Pressable onPress={handleSubmit(handleSignup)} className=" rounded-lg overflow-hidden mb-6">
                        <LinearGradient
