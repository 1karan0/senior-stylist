  ...
  return (
    <View className="flex-1 bg-white">
      ...
      <GradientBackground className="flex-1 px-5 pt-16">
        {/* Header */}
        <Text className="text-[26px] font-semibold text-gray-900">Chats</Text>
        <Text className="text-gray-500 mt-1">Manage your styling sessions</Text>

        {/* Card */}
        <View className="bg-white rounded-2xl shadow-md mt-10 p-6 items-center border border-gray-100">
          {/* Chat Icon */}
          ...
          {/* Title */}
          <Text className="text-xl font-semibold text-gray-900 mb-1">No Chats</Text>

          {/* Subtitle */}
          <Text className="text-gray-500 text-center px-4 mb-6">
          ...
          >
            <Image source={require('@/assets/white-search-icon.png')} className="w-5 h-5 mr-2" />
