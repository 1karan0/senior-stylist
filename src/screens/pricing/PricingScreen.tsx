    ...
    return (
        <View className="flex-1 bg-white px-6">
            ...
            <View className="mt-6 items-center">
                ...
                <Text className="text-sm text-[#658176] mt-2">
                ...
                {plans.map((item) => {
                    ...
                    return (
                        <Pressable
                            ...
                            className={`rounded-md border px-4 py-4 ${active ? "border-[#23A76F]" : "border-[#E2E8F0]"
                                } bg-white`}
                        >
                            <View className="flex-row items-center justify-between">
                                ...
                                <View className="flex-row items-center gap-3">
                                    {/* Radio Button */}
                                    <View
                                        className={`w-5 h-5 rounded-full border ${active ? "border-[#23A76F]" : "border-[#94A3B8]"
                                            } items-center justify-center`}
                                    >
                                        {active && (
                                            <View className="w-3 h-3 rounded-full bg-[#23A76F]" />
                                        )}
                                    </View>

                                    <View>
                                        <Text className="text-[#162721] font-semibold text-[16px]">
                                            {item.title}
                                        </Text>

                                        <View className="flex-row items-baseline mt-1">
                                            <Text className="text-[#162721] font-bold text-[20px]">
                                                {item.price}
                                            </Text>
                                            <Text className="text-[#162721] font-medium ml-1">
                                                {item.priceSub}
                                            </Text>
                                        </View>
            ...
            {/* BUTTON */}
            <Pressable onPress={() => setSubscriptionModal(true)} className="mt-10 rounded-xl overflow-hidden">
                <LinearGradient
